      ...
      <motion.div
        ...
        <div className="max-w-7xl">
          ...
          <motion.h1
            ...
            className="font-bold tracking-tight leading-[1.1] whitespace-pre-line text-white [font-family:'Blauer_Nue',_'Dubai',_ui-sans-serif,_system-ui,_sans-serif] text-xl md:text-xl lg:text-xl">
